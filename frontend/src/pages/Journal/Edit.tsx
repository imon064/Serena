...
export const JournalEdit: React.FC = () => {
  ...
  const { getEntryForDate, updateEntry } = useJournal();
    ...
    return (
      <div className="min-h-screen bg-lavender flex items-center justify-center p-4">
        <div className="w-full max-w-[420px] bg-white rounded-[32px] p-8 shadow-card text-center">
          ...
          <p className="text-slate-500 text-sm mb-6">We couldn't find a journal entry to edit.</p>
          <button
    ...
    <div className="min-h-screen bg-lavender flex items-center justify-center p-4 sm:p-6 md:p-8">
      ...
      <div className="w-full max-w-[420px] bg-white rounded-[32px] shadow-card border border-slate-100/50 flex flex-col min-h-[780px] relative overflow-hidden animate-slideUp">
        ...
        <div className="px-6 pt-6 pb-4 flex items-center justify-between border-b border-slate-50">
          <button
            onClick={() => navigate(`/journal/detail/${date}`)}
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="border border-slate-200 rounded-[18px] flex flex-col bg-white overflow-hidden shadow-sm">
              <div className="flex items-center gap-4 px-4 py-3 bg-slate-50/80 border-b border-slate-100 text-slate-500 text-xs">
                <button type="button" onClick={() => alert('Format Bold (Demo)')} className="hover:text-brand transition-colors"><Bold size={15} strokeWidth={2.5} /></button>
                <button type="button" onClick={() => alert('Format Italic (Demo)')} className="hover:text-brand transition-colors"><Italic size={15} strokeWidth={2.5} /></button>
                <button type="button" onClick={() => alert('Format List (Demo)')} className="hover:text-brand transition-colors"><List size={15} strokeWidth={2.5} /></button>
                <button type="button" onClick={() => alert('Insert Link (Demo)')} className="hover:text-brand transition-colors"><LinkIcon size={14} strokeWidth={2.5} /></button>
                <button type="button" onClick={() => alert('Blockquote (Demo)')} className="hover:text-brand transition-colors"><Quote size={14} strokeWidth={2.5} /></button>
                <div className="flex-1" />
                <button type="button" onClick={() => setContent(c => c.slice(0, -10))} className="hover:text-brand transition-colors"><Undo2 size={15} strokeWidth={2.5} /></button>
              </div>
